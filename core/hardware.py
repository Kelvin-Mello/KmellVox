...
class ModelProfile:
    ...
    translation_model: str = "Qwen2.5-1.5B-Instruct-Q4_K_M"
    translation_model_family: str = "Qwen2.5"
    translation_repo_id: str = "bartowski/Qwen2.5-1.5B-Instruct-GGUF"
    translation_filename: str = "Qwen2.5-1.5B-Instruct-Q4_K_M.gguf"
    ...
    def from_profile(cls, profile_name: Optional[str] = None, config_path: str = "config.yaml") -> "ModelProfile":
        ...
        if norm in ("perfil_a", "high_vram", "mid_vram"):
            return cls(
                ...
                translation_model_family="Qwen2.5",
                translation_repo_id="bartowski/Qwen2.5-7B-Instruct-GGUF",
                translation_filename="Qwen2.5-7B-Instruct-Q4_K_M.gguf",
            ...
            return cls(
                ...
                translation_model="Qwen2.5-3B-Instruct-Q4_K_M",
                translation_model_family="Qwen2.5",
                translation_repo_id="bartowski/Qwen2.5-3B-Instruct-GGUF",
                translation_filename="Qwen2.5-3B-Instruct-Q4_K_M.gguf",
                default_tts_engine="F5-TTS",
            ...
            return cls(
                ...
                translation_model="Qwen2.5-1.5B-Instruct-Q4_K_M",
                translation_model_family="Qwen2.5",
                translation_repo_id="bartowski/Qwen2.5-1.5B-Instruct-GGUF",
                translation_filename="Qwen2.5-1.5B-Instruct-Q4_K_M.gguf",
                default_tts_engine="F5-TTS",
