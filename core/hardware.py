...
class ModelProfile:
    ...
    translation_model: str = "Qwen3-0.6B-Q4_K_M"
    translation_model_family: str = "Qwen3"
    translation_repo_id: str = "unsloth/Qwen3-0.6B-GGUF"
    translation_filename: str = "Qwen3-0.6B-Q4_K_M.gguf"
    ...
    def from_profile(cls, profile_name: Optional[str] = None, config_path: str = "config.yaml") -> "ModelProfile":
        ...
        if norm in ("perfil_a", "high_vram", "mid_vram"):
            return cls(
                ...
                translation_model="Qwen3-8B-Q4_K_M",
                translation_model_family="Qwen3",
                translation_repo_id="Qwen/Qwen3-8B-GGUF",
                translation_filename="Qwen3-8B-Q4_K_M.gguf",
            ...
            return cls(
                ...
                translation_model_family="Qwen3",
                translation_repo_id="unsloth/Qwen3-4B-Instruct-2507-GGUF",
                translation_filename="Qwen3-4B-Instruct-2507-Q4_K_M.gguf",
                default_tts_engine="F5-TTS",
            ...
            return cls(
                ...
                translation_model="Qwen3-0.6B-Q4_K_M",
                translation_model_family="Qwen3",
                translation_repo_id="unsloth/Qwen3-0.6B-GGUF",
                translation_filename="Qwen3-0.6B-Q4_K_M.gguf",
                default_tts_engine="F5-TTS",
