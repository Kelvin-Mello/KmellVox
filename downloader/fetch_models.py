...
MODEL_CATALOG: List[ModelDownloadSpec] = [
    ...
    ModelDownloadSpec(
        ...
        destination_rel="llm/Qwen2.5-7B-Instruct-Q4_K_M.gguf",
        profiles=["perfil_a"],
        description="Qwen2.5 7B Q4_K_M (Tradução contextual de estúdio para perfil_a)",
    ...
    ModelDownloadSpec(
        ...
        destination_rel="llm/Qwen2.5-3B-Instruct-Q4_K_M.gguf",
        profiles=["perfil_b"],
        description="Qwen2.5 3B Q4_K_M (Tradução balanceada para perfil_b 6GB)",
        expected_min_bytes=1800 * 1024 * 1024,
    ),
    ModelDownloadSpec(
        key="llm_qwen_1_5b",
        ...
        destination_rel="llm/Qwen2.5-1.5B-Instruct-Q4_K_M.gguf",
        profiles=["cpu"],
        description="Qwen2.5 1.5B Q4_K_M (Tradução leve para CPU)",
