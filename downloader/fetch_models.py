...
MODEL_CATALOG: List[ModelDownloadSpec] = [
    ...
    ModelDownloadSpec(
        ...
        destination_rel="llm/Qwen3-8B-Q4_K_M.gguf",
        profiles=["perfil_a"],
    ...
    ModelDownloadSpec(
        ...
        destination_rel="llm/Qwen3-4B-Instruct-2507-Q4_K_M.gguf",
        profiles=["perfil_b"],
        description="Qwen3 4B Instruct 2507 Q4_K_M (Tradução balanceada para perfil_b 6GB)",
    ...
    ModelDownloadSpec(
        ...
        destination_rel="llm/Qwen3-0.6B-Q4_K_M.gguf",
        profiles=["cpu"],
        description="Qwen3 0.6B Q4_K_M (Tradução leve para CPU)",
        expected_min_bytes=350 * 1024 * 1024,
    ),
